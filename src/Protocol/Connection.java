...
public class Connection {
    ...
    public Connection(String host, int port, boolean _verbose, boolean _debug) throws IOException {
        verbose = _verbose;
        debug = _debug;
    ...
    public void writeString(String message) throws IOException {
        if (message != null) {
            ...
            if (verbose) System.out.println("C SEND: " + message);
            outStream.flush();
        }
    }
    ...
    public String readString() throws IOException {
        ...
        if (verbose) System.out.println("C RECV: " + output);
